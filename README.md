...
.. an additional idea it to use it with the layer diffusion extension in combination to to make the somtimes unstable background invisible, using
that methode it "should be" possible to resurrect a person of a photo to a somehow 3D looking person with a additional background you can add to the
